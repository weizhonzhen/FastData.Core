...
namespace FastData.Core.Repository
{
    public class Queryable<T> : IQueryable<T> where T : class, new()
    {
        ...
        /// <returns></returns>
        private IQueryable<T> JoinType<T1>(string joinType, Expression<Func<T, T1, bool>> predicate, Expression<Func<T1, object>> field = null, bool isDblink = false)
        {
        ...
        /// <returns></returns>
        public override IQueryable<T> LeftJoin<T1>(Expression<Func<T, T1, bool>> predicate, Expression<Func<T1, object>> field = null, bool isDblink = false)
        {
        ...
        /// <param name="field"></param>
        /// <returns></returns>
        public override IQueryable<T> RightJoin<T1>(Expression<Func<T, T1, bool>> predicate, Expression<Func<T1, object>> field = null, bool isDblink = false)
        {
        ...
        /// <param name="field"></param>
        /// <returns></returns>
        public override IQueryable<T> InnerJoin<T1>(Expression<Func<T, T1, bool>> predicate, Expression<Func<T1, object>> field = null, bool isDblink = false)
        {
